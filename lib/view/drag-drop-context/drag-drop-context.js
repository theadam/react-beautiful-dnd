...
var DragDropContext = function (_React$Component) {
  ...
  DragDropContext.prototype.getChildContext = function getChildContext() {
    ...
    return _ref = {}, _ref[_contextKeys.storeKey] = this.store, _ref[_contextKeys.dimensionMarshalKey] = this.dimensionMarshal, _ref[_contextKeys.styleContextKey] = this.styleMarshal.styleContext, _ref[_contextKeys.canLiftContextKey] = this.canLift, _ref[_contextKeys.preventWindowScrollContextKey] = this.props.preventWindowScroll || false, _ref;
  };
