...
exports.default = function (_ref3) {
  ...
  var scroller = function scroller(state, preventWindowScroll) {
    var drag = state.drag;
    if (!drag) {
    ...
    if (!preventWindowScroll && requiredWindowScroll && (0, _canScroll.canScrollWindow)(viewport, requiredWindowScroll)) {
