...
var completeLift = exports.completeLift = function completeLift(id, client, viewport, autoScrollMode, preventWindowScroll) {
  return {
    type: 'COMPLETE_LIFT',
    payload: {
      id: id,
...
var lift = exports.lift = function lift(id, client, viewport, autoScrollMode, preventWindowScroll) {
  return function (dispatch, getState) {
